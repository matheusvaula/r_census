...
classi = glm(formula = Ganha_mais_que_50k ~.,family = binomial, data = base_treino);

probab = predict(classi, type= "response", newdata = base_teste);

previsoes = ifelse(probab >= 0.5, 1, 0);
